...
template <> constexpr inline auto Wizard::qt_create_metaobjectdata<qt_meta_tag_ZN6WizardE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(const QVariantHash &)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void Wizard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->selectedGroupChanged((*reinterpret_cast<std::add_pointer_t<QVariantHash>>(_a[1]))); break;
        default: ;
        }
    }
}
