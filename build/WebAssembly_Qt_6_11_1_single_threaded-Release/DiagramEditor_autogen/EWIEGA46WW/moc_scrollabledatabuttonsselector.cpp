/****************************************************************************
** Meta object code from reading C++ file 'scrollabledatabuttonsselector.h'
**
...
#error "The header file 'scrollabledatabuttonsselector.h' doesn't include <QObject>."
...
template <> constexpr inline auto DiagramEditor::Gui::ScrollableDataButtonsSelector::qt_create_metaobjectdata<qt_meta_tag_ZN13DiagramEditor3Gui29ScrollableDataButtonsSelectorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QVariantHash &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'buttonToggled'
...
void DiagramEditor::Gui::ScrollableDataButtonsSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->selectionChanged((*reinterpret_cast<std::add_pointer_t<QVariantHash>>(_a[1]))); break;
        case 1: _t->buttonToggled((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ScrollableDataButtonsSelector::*)(const QVariantHash & )>(_a, &ScrollableDataButtonsSelector::selectionChanged, 0))
            return;
    }
}
